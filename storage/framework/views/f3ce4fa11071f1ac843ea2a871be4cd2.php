...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
     <head>
          ...
          <style>
               body {
                    background: url('<?php echo e(asset('image/electromenager.jpg')); ?>') no-repeat center center;
          ...
          <div class="container">
               <div class="form-container">
                    <div class="form-left">  
                         ...
                         <form action="<?php echo e(route('updateService_administrateur', $service->id_service)); ?>" method="POST" enctype="multipart/form-data">
                              <?php echo csrf_field(); ?>
                              ...
                              <div class="form-group">
                                   ...
                                   <?php if($service->electromenager && $service->electromenager->image_electromenager): ?>
                                        <div class="photo-container" style="width:450px; background-image: url('<?php echo e(asset('storage/images'.'/'.$service->electromenager->image_electromenager)); ?>');"></div>
                                   <?php else: ?>
                                        N/A
                                   <?php endif; ?>
                                   </div>         
                              ...
                              <div class="form-group">
                                   <label for="id_electromenager">Appareil électronique :</label> 
                                   <strong> <?php echo e($service->electromenager->nom_electromenager ?? 'N/A'); ?> </strong>                        
                              </div>

                              <div class="form-group">
                                   <label for="id_electromenager">Puissance :</label> 
                                   <strong> <?php echo e($service->electromenager->puissance_electromenager); ?> </strong>Watts                        
                              </div>

                              <div class="form-group">
                                   <label for="id_electromenager">Tension :</label> 
                                   <strong> <?php echo e($service->electromenager->tension_electromenager); ?> </strong>Volts                        
                              </div>

                              <div class="form-group">
                                   <label for="id_localisation">Localisation :</label> 
                                   <strong> <?php echo e($service->localisation->nom_localisation); ?> </strong>                        
                              </div>

                              <div class="form-group">
                                   <label for="description_service">Description :</label> 
                                   <strong> <?php echo e($service->description_service); ?> </strong>                        
                              </div>

                              <div class="form-group">
                                   <label for="prix_service">Prix unitaire :</label> 
                                   <strong><?php echo e($service->prix_service); ?> CFA</strong>                        
                              </div>
                              
                              <div class="form-group">
                                   <label for="id_magasin">Stock en magasin :</label> 
                                   <strong> <?php echo e($service->magasin->stock_magasin); ?> </strong>                        
                              </div>
                              
                              <div class="form-group">
                                   <label for="total_service">Prix total (en FCFA) :</label> 
                                   <strong><?php echo e($service->total_service); ?> CFA</strong>                        
                              </div>

                              <div class="form-group">
                                   <label for="matricule">Responsable :</label> 
                                   <strong> "<?php echo e($service->user->role); ?>" : &nbsp;&nbsp;<?php echo e($service->user->nom); ?> <?php echo e($service->user->prenom); ?> </strong>                        
                              </div>
...
</html><?php /**PATH T:\Soutenance_de_JORDANIE_EVE\Nouveau_Projet\gestion_plateforme_anonces\resources\views/authentification/administrateur/service/OpenService_administrateur.blade.php ENDPATH**/ ?>