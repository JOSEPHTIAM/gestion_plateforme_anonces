          ...
          <div class="container">
               <div class="form-container">
                    ...
                    <div class="form-left">
                         ...
                         <br>
                         <form id="timeForm" action="<?php echo e(route('storeTimeClient')); ?>" method="POST">
                              <?php echo csrf_field(); ?>
                              ...
                              <div class="form-group text-center">
                                   ...
                                   <script>
                                        function connexionUtilisateur() {
                                             window.location.href = "<?php echo e(url('connexionUtilisateur')); ?>";
                                        }
                                   </script>
                              </div>
...
<?php /**PATH T:\Soutenance_de_JORDANIE_EVE\Nouveau_Projet\gestion_plateforme_anonces\resources\views/authentification/utilisateur/client/tokenClient.blade.php ENDPATH**/ ?>