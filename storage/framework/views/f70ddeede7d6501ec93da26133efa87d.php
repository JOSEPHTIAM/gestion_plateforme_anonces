...
<html lang="en">
    ...
    <head>
        ...
        <title>Liste des paniers chez l'administrateur</title>
        ...
        <div class="container">
            <div class="navigation">
                <ul>
                    ...
                    <li>
                        <a href="<?php echo e(route('listePaniers_administrateur')); ?>">
                            <span class="icon_actuellement">
                                <ion-icon name="chatbubble-outline"></ion-icon>
                            </span>
                            <span class="title_actuellement">Paniers</span>
                        </a>
                    </li>

                    <li>
                        <a href="<?php echo e(route('listeTransactions_administrateur')); ?>" class="navigate-to-transactions">
                            <span class="icon">
                ...
                <div class="cardBox">
                    ...
                    <a href="<?php echo e(route('listePaniers_administrateur')); ?>" style="text-decoration: none; color: inherit;">
                        <div class="card_actuellement">
                            <div>
                                <div class="numbers_actuellement">Panier</div>
                    ...
                    <a href="<?php echo e(route('listeTransactions_administrateur')); ?>" style="text-decoration: none; color: inherit;" class="navigate-to-transactions">
                        <div class="card">
                            <div>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                document.querySelectorAll('.navigate-to-transactions').forEach(button => {
                    button.addEventListener('click', function(event) {
                        event.preventDefault();
                        localStorage.setItem('cart', JSON.stringify(cart));
                        window.location.href = "<?php echo e(route('listeTransactions_administrateur')); ?>";
                    });
                });
            });
...
</html><?php /**PATH T:\Soutenance_de_JORDANIE_EVE\Nouveau_Projet\gestion_plateforme_anonces\resources\views/authentification/administrateur/panier/listePaniers_administrateur.blade.php ENDPATH**/ ?>