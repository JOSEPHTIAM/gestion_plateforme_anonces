...
<html lang="en">
    ...
    <head>
        ...
        <title>Liste des administrateurs chez l'administrateur</title>
        <!-- Bootstrap Icons -->
        ...
        <div class="container">
            <div class="navigation">
                <ul>
                    ...
                    <li>
                        <a href="<?php echo e(route('listeAdministrateurs_administrateur')); ?>">
                            ...
                            <span class="title_actuellement">Administrateurs</span>
                        </a>
                    </li>
               ...
               <div class="main">
                    ...
                    <form action="/searchAdministrateur_administrateur" class="form-inline">
                    <div class="topbar">
                    <div class="toggle">
                    ...
                    <div class="search">
                         <label for="keyword">
                            <input type="text" id="keyword" name="keyword" class="form-control" required placeholder="Rechercher un administrateur">
                ...
                <div class="details">
                    <div class="recentOrders">
                        <div class="cardHeader">
                            <h2 align="center"><font size="7">LISTE DES ADMINISTRATEURS</font></h2>
                                                        
                            <a href="/nouveauAdministrateur_administrateur" class="btn_nouveau">
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                                    ...
                                                    <td><?php echo e($user->statut); ?></td>
                                                       <td>
                                                            <span class="status actuellement">
                                                                 <a href="<?php echo e(url('/OpenAdministrateur_administrateur/' . $user->matricule)); ?>" class="btn btn-secondary" onclick="return confirm('Êtes-vous sûr de visualiser les détails de cet administrateur ?');">
                                                                    <font color="white"><ion-icon name="eye-outline"></ion-icon></font>
                                                                 </a>
                                                            </span> &nbsp;&nbsp;
                                                            <span class="status pending">
                                                                 <a href="<?php echo e(route('editAdministrateur_administrateur', $user->matricule)); ?>" class="btn btn-primary" onclick="return confirm('Êtes-vous sûr de vouloir modifier cet administrateur ?');">
                                                                    <font color="white"><i class="bi bi-pencil"></i></font>
                                                                 </a>
                                                            </span> &nbsp;&nbsp;
                                                            <span class="status return">
                                                                 <a href="<?php echo e(url('/deleteAdministrateur_administrateur/' . $user->matricule)); ?>" class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet administrateur ?');">
                                    ...
                                    <?php else: ?>
                                            <?php $__currentLoopData = \App\Models\User::where('role', 'Administrateur')->paginate(1000); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td>
                                                        <?php if($user->photo): ?>
                                                            <img src="<?php echo e(asset('storage/images'.'/'.$user->photo)); ?>" alt="Photo" width="50" height="50">
...
</html><?php /**PATH T:\Soutenance_de_JORDANIE_EVE\Nouveau_Projet\gestion_plateforme_anonces\resources\views/authentification/administrateur/agent/listeAdministrateurs_administrateur.blade.php ENDPATH**/ ?>