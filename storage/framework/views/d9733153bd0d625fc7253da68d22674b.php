          ...
          <div class="container">
               ...
               <div class="form-container">
                    ...
                    <div class="form-left">                    
                         ...
                         <form action="<?php echo e(route('storeService_administrateur')); ?>" method="post" enctype="multipart/form-data">
                              <?php echo csrf_field(); ?>
                              ...
                              <div class="form-row">
                                   ...
                                   <select name="id_electromenager" id="id_electromenager" class="form-control">
                                        ...
                                        <?php $__currentLoopData = \App\Models\Electromenager::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $electromenager): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                             <option value="<?php echo e($electromenager->id_electromenager); ?>">
                                                  "" <?php echo e($electromenager->nom_electromenager); ?> "" de <?php echo e($electromenager->puissance_electromenager); ?>Watts -- <?php echo e($electromenager->tension_electromenager); ?>Volts
                                             </option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                   </select>
                                   </div>
                              ...
                              <div class="form-row">
                                   ...
                                   <input type="text" id="description_service" name="description_service" class="form-control" value="<?php echo e(old('description_service')); ?>" placeholder="Bonne qualité">
                                   </div>
                              </div>
...
<?php /**PATH T:\Soutenance_de_JORDANIE_EVE\Nouveau_Projet\gestion_plateforme_anonces\resources\views/authentification/administrateur/service/nouveauService_administrateur.blade.php ENDPATH**/ ?>