<!DOCTYPE html>
     ...
     <head>
          ...
          <title>Page du nouvel appareil ordinateur du coté administrateur</title>
     ...
     <body>
          ...
          <div class="container">
               ...
               <div class="form-container">
                    ...
                    <div class="form-left">                    
                         <h2 align="center">
                              <font color="#000076"><b><strong>Nouvel appareil ordinateur</strong></b></font>
                         </h2>
                         ...
                         <form action="<?php echo e(route('storeOrdinateur_administrateur')); ?>" method="post" enctype="multipart/form-data">
                              <?php echo csrf_field(); ?>
                                                            
                              <div class="form-row">
                                    <div class="form-group col-md-12">
                                        <label for="image_ordinateur">
                                            <i class="fas fa-graduation-cap"></i> 
                                            Photo :
                                        </label>
                                        <input type="file" id="image_ordinateur" name="image_ordinateur" class="form-control" value="<?php echo e(old('image_ordinateur')); ?>">
                                   </div>
                                   
                                   <div class="form-group col-md-12">
                                        <label for="nom_ordinateur">
                                             ...
                                             Nom de l'appareil <font color="red">*</font> :
                                        </label>
                                        <input type="text" id="nom_ordinateur" name="nom_ordinateur" class="form-control" value="<?php echo e(old('nom_ordinateur')); ?>" placeholder="DELL" required>
                                        <?php $__errorArgs = ['nom_ordinateur'];
                              ...
                              <div class="form-row">
                                   <div class="form-group col-md-12">
                                        <label for="processeur">
                                             ...
                                             Processeur de l'appareil <font color="red">*</font> :
                                        </label>
                                        <input type="text" id="processeur" name="processeur" class="form-control" value="<?php echo e(old('processeur')); ?>" placeholder="Intel 3GHZ" required>
                                        <?php $__errorArgs = ['processeur'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                   ...
                                   <div class="form-group col-md-12">
                                        <label for="disque">
                                             ...
                                             Disque dur de l'appareil <font color="red">*</font> :
                                        </label>
                                        <input type="text" id="disque" name="disque" class="form-control" value="<?php echo e(old('disque')); ?>" placeholder="SDD 476" required>
                                        <?php $__errorArgs = ['tension_electromenager'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                              ...
                              <div class="form-row">
                                   <div class="form-group col-md-12">
                                        <label for="ram">
                                             ...
                                             RAM de l'appareil <font color="red">*</font> :
                                        </label>
                                        <input type="number" id="ram" name="ram" class="form-control" value="<?php echo e(old('ram')); ?>" placeholder="16" required>
                                        <?php $__errorArgs = ['ram'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                                   ...
                                   <div class="form-group col-md-12">
                                        <label for="core">
                                             ...
                                             Core génération de l'appareil <font color="red">*</font> :
                                        </label>
                                        <input type="text" id="core" name="core" class="form-control" value="<?php echo e(old('core')); ?>" placeholder="i7" required>
                                        <?php $__errorArgs = ['core'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                              ...
                              <div class="form-group text-center">
                                   ...
                                   <button onclick="listeOrdinateurs_administrateur()" type="reset" class="btn btn-danger">
                                   ...
                                   <script>
                                   function listeOrdinateurs_administrateur() {
                                        window.location.href = "<?php echo e(url('listeOrdinateurs_administrateur')); ?>";
                                   }
                                   </script>
                              </div>
                         </form>
...
<?php /**PATH T:\Soutenance_de_JORDANIE_EVE\Nouveau_Projet\gestion_plateforme_anonces\resources\views/authentification/administrateur/ordinateur/nouveauOrdinateur_administrateur.blade.php ENDPATH**/ ?>