     ...
     <head>
          ...
          <title>Page du nouveau administrateur</title>
     ...
     <body>
          ...
          <nav class="navbar">
               ...
               <div>
                    ...
                    <script>
                         function connexion() {
                         window.location.href = "<?php echo e(url('/connexion')); ?>";
                         }
                    </script>               
               </div>
          </nav>
          ...
          <div class="container">
               ...
               <div class="form-container">
                    ...
                    <div class="form-left">                    
                         ...
                         <form action="<?php echo e(route('utilisateur.store')); ?>" method="post" enctype="multipart/form-data">
                              <?php echo csrf_field(); ?>
                              ...
                              <div class="form-row">
                                   ...
                                   <div class="form-group col-md-12">
                                        ...
                                        <input type="file" id="photo" name="photo" class="form-control" value="<?php echo e(old('photo')); ?>">
                                   </div>
                              </div>
                              ...
                              <div class="form-row">
                                   <div class="form-group col-md-12">
                                        ...
                                        <input type="text" id="nom" name="nom" class="form-control" value="<?php echo e(old('nom')); ?>" required>
                                   </div>
                                   <div class="form-group col-md-12">
                                        <label for="prenom">
                                             <i class="fas fa-user"></i>
                                        ...
                                        <input type="text" id="prenom" name="prenom" class="form-control" value="<?php echo e(old('prenom')); ?>">
                                   </div>
                              </div>
                              ...
                              <div class="form-row">
                                   <div class="form-group col-md-12">
                                        ...
                                        <input type="tel" id="contact" name="contact" class="form-control" value="<?php echo e(old('contact')); ?>" required min="0">
                                   </div>                    
                              </div>
                              ...
                              <div class="form-row d-none" id="statut_administrateur">
                                   <div class="form-group col-md-12">
                                        ...
                                        <input type="text" id="statut" name="statut" class="form-control" value="<?php echo e(old('statut')); ?>">
                                   </div>
                              </div>
                              ...
                              <div class="form-row d-none" id="agentFields">
                                   <div class="form-group col-md-12">
                                        ...
                                        <input type="text" id="nom_societe" name="nom_societe" class="form-control" value="<?php echo e(old('nom_societe')); ?>">
                                   </div>
                                   <div class="form-group col-md-12">
                                        ...
                                        <input type="number" id="numero_societe" name="numero_societe" class="form-control" value="<?php echo e(old('numero_societe')); ?>" min="0">
                                   </div>
                                   <div class="form-group col-md-12">
                                        ...
                                        <input type="file" id="non_redevence" name="non_redevence" class="form-control" accept=".pdf,.doc,.docx,.jpg,.png" value="<?php echo e(old('non_redevence')); ?>">
                                   </div>
                              </div>
...
<?php /**PATH T:\Soutenance_de_JORDANIE_EVE\Nouveau_Projet\gestion_plateforme_anonces\resources\views/authentification/administrateur/nouveauAdministrateur.blade.php ENDPATH**/ ?>