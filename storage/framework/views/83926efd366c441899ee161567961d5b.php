     ...
     <head>
          ...
          <title>Page du token d'administrateur</title>
     ...
     <body>
          ...
          <div class="container">
               <div class="form-container">
                    ...
                    <div class="form-left">
                         <h2>
                              <font color="#000076"><b><strong>Vous êtes à présent un administrateur !</strong></b></font>
                         </h2>
                         ...
                         <br>
                         <form id="timeForm" action="<?php echo e(route('storeTimeAdministrateur')); ?>" method="POST">
                              <?php echo csrf_field(); ?>
                              ...
                              <div class="form-group text-center">
                                   ...
                                   <button onclick="connexionAdministrateur()" type="reset" class="btn btn-danger">
                                   ...
                                   <script>
                                        function connexionAdministrateur() {
                                             window.location.href = "<?php echo e(url('connexionAdministrateur')); ?>";
                                        }
                                   </script>
                              </div>
...
<?php /**PATH T:\Soutenance_de_JORDANIE_EVE\Nouveau_Projet\gestion_plateforme_anonces\resources\views/authentification/administrateur/tokenAdministrateur.blade.php ENDPATH**/ ?>