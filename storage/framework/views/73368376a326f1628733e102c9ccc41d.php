     ...
     <head>
          ...
          <title>Page du nouveau magasin du coté administrateur</title>
          ...
          <style>
               body {
                    background: url('image/logo_6.jpg') no-repeat center center;
     ...
     <body>
          ...
          <div class="container">
               ...
               <div class="form-container">
                    ...
                    <div class="form-left">                    
                         <h2>
                              <font color="#000076"><b><strong>Nouveau magasin</strong></b></font>
                         </h2>
                         ...
                         <form action="<?php echo e(route('storeMagasin_administrateur')); ?>" method="post" enctype="multipart/form-data">
                              <?php echo csrf_field(); ?>
                                                            
                              <div class="form-row">
                                   <div class="form-group col-md-12">
                                        <label for="stock_magasin">
                                             ...
                                             Quantité en stock <font color="red">*</font> :
                                        </label>
                                        <input type="number" id="stock_magasin" name="stock_magasin" class="form-control" value="<?php echo e(old('stock_magasin')); ?>" placeholder="3" required>
...
<?php /**PATH T:\Soutenance_de_JORDANIE_EVE\Nouveau_Projet\gestion_plateforme_anonces\resources\views/authentification/administrateur/magasin/nouveauMagasin_administrateur.blade.php ENDPATH**/ ?>