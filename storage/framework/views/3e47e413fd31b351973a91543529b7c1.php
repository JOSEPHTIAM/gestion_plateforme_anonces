                        ...
                        <div class="cardHeader">
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    <?php if(isset($users)): ?>
                                            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e($user->nom_societe); ?></td>
                                                    <td><?php echo e($user->numero_societe); ?></td>
                                                    <td>                                                        
                                                        <span class="status actuellement">
                                                            <a href="<?php echo e(url('/OpenAgent_administrateur/' . $user->matricule)); ?>" class="btn btn-secondary" onclick="return confirm('Êtes-vous sûr de visualiser les détails de cet agent ?');">
                                                                <font color="white"><ion-icon name="eye-outline"></ion-icon></font>
                                                            </a>
                                                        </span> &nbsp;&nbsp;
                                                        <span class="status pending">
                                                            <a href="<?php echo e(route('editAgent_administrateur', $user->matricule)); ?>" class="btn btn-primary" onclick="return confirm('Êtes-vous sûr de vouloir modifier cet agent ?');">
                                                                <font color="white"><i class="bi bi-pencil"></i></font>
                                                            </a>
                                                        </span> &nbsp;&nbsp;
                                                        <span class="status return">
                                                            <a href="<?php echo e(url('/deleteAgent_administrateur/' . $user->matricule)); ?>" class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet agent ?');">
                                    ...
                                    <?php else: ?>
                                            <?php $__currentLoopData = \App\Models\User::where('role', 'Agent')->paginate(1000); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td>
                                                        <?php if($user->photo): ?>
                                                            <img src="<?php echo e(asset('storage/images'.'/'.$user->photo)); ?>" alt="Photo" width="50" height="50">
...
</html><?php /**PATH T:\Soutenance_de_JORDANIE_EVE\Nouveau_Projet\gestion_plateforme_anonces\resources\views/authentification/administrateur/agent/listeAgents_administrateur.blade.php ENDPATH**/ ?>