<!DOCTYPE html>
     ...
     <head>
          ...
          <title>Page de modification du magasin du coté administrateur</title>
          ...
          <style>
               body {
                    background: url('<?php echo e(asset('image/logo_6.jpg')); ?>') no-repeat center center;
     ...
     <body>
          ...
          <div class="container">
               ...
               <div class="form-container">
                    ...
                    <div class="form-left">  
                         <h2 align="center">
                              <font color="#000076"><b><strong>Modification du magasin</strong></b></font>
                         </h2>
                         ...
                         <form action="<?php echo e(route('updateMagasin_administrateur', $magasin->id_magasin)); ?>" method="POST" enctype="multipart/form-data">
                              <?php echo csrf_field(); ?>
                              <?php echo method_field('POST'); ?>

                              
                              <div class="form-group">
                                   <label for="stock_magasin">Boutique :</label>
                                   <input type="number" class="form-control" id="stock_magasin" name="stock_magasin" value="<?php echo e(old('stock_magasin', $magasin->stock_magasin)); ?>" required>
                                   <?php $__errorArgs = ['stock_magasin'];
...
unset($__errorArgs, $__bag); ?>
                              ...
                              <div class="form-group text-center">
                                   ...
                                   <button onclick="listeMagasins_administrateur()" type="reset" class="btn btn-danger">
                                   ...
                                   <script>
                                   function listeMagasins_administrateur() {
                                        window.location.href = "<?php echo e(url('listeMagasins_administrateur')); ?>";
                                   }
                                   </script>
                              </div>
                         </form>
...
<?php /**PATH T:\Soutenance_de_JORDANIE_EVE\Nouveau_Projet\gestion_plateforme_anonces\resources\views/authentification/administrateur/magasin/editMagasin_administrateur.blade.php ENDPATH**/ ?>