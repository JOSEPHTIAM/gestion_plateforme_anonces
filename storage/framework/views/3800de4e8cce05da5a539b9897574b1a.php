                        ...
                        <div class="cca-cards-container">
                            ...
                            <div class="cca-card">
                                <div class="cca-card__header">
                                    <div class="cca-card__logo">
                                        <img src="<?php echo e(asset('image/cca_2.jpg')); ?>" alt="CCA Logo">
                                    </div>
                                    <div class="cca-card__chip">
                                        <img src="<?php echo e(asset('image/cameroun.jpg')); ?>" alt="Chip">
                                    </div>
                                </div>
                            ...
                            <div class="cca-card-back">
                                ...
                                <div class="cca-card-back__logo">
                                    <img src="<?php echo e(asset('image/paypal.jpg')); ?>" alt="CCA Logo">
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="popup-buttons">
                                    ...
                                    <script>
                                            function listeTransactions_administrateur() {
                                                    window.location.href = "<?php echo e(url('listeTransactions_administrateur')); ?>";
                                            }
                                    </script>
...
</html><?php /**PATH T:\Soutenance_de_JORDANIE_EVE\Nouveau_Projet\gestion_plateforme_anonces\resources\views/authentification/administrateur/transaction/listeTransactions_administrateur.blade.php ENDPATH**/ ?>