     ...
     <head>
          ...
          <title>Page du nouvelle localisation du coté administrateur</title>
          ...
          <style>
               body {
                    background: url('image/localisation.jpg') no-repeat center center;
     ...
     <body>
          ...
          <div class="container">
               ...
               <div class="form-container">
                    ...
                    <div class="form-left">                    
                         <h2 align="center">
                              <font color="#000076"><b><strong>Nouvelle localisation</strong></b></font>
                         </h2>
                         ...
                         <form action="<?php echo e(route('storeLocalisation_administrateur')); ?>" method="post" enctype="multipart/form-data">
                              <?php echo csrf_field(); ?>
                                                            
                              <div class="form-row">
                                   <div class="form-group col-md-12">
                                        <label for="nom_localisation">
                                             ...
                                             Nom de la boutique <font color="red">*</font> :
                                        </label>
                                        <input type="text" id="nom_localisation" name="nom_localisation" class="form-control" value="<?php echo e(old('nom_localisation')); ?>" placeholder="Entreprise" required>
...
unset($__errorArgs, $__bag); ?>
                                   ...
                                   <div class="form-group col-md-12">
                                        <label for="quartier_localisation">
                                             <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-postcard-fill" viewBox="0 0 16 16">
                                                  <path d="M11 8h2V6h-2z"/>
                                                  <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm8.5.5a.5.5 0 0 0-1 0v7a.5.5 0 0 0 1 0zM2 5.5a.5.5 0 0 0 .5.5H6a.5.5 0 0 0 0-1H2.5a.5.5 0 0 0-.5.5M2.5 7a.5.5 0 0 0 0 1H6a.5.5 0 0 0 0-1zM2 9.5a.5.5 0 0 0 .5.5H6a.5.5 0 0 0 0-1H2.5a.5.5 0 0 0-.5.5m8-4v3a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 .5-.5v-3a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5"/>
                                             </svg>
                                             Quartier <font color="red">*</font> :
                                        </label>
                                        <input type="text" id="quartier_localisation" name="quartier_localisation" class="form-control" value="<?php echo e(old('quartier_localisation')); ?>" placeholder="Quartier" required>
...
unset($__errorArgs, $__bag); ?>
                              ...
                              <div class="form-row">
                                   <div class="form-group col-md-12">
                                        <label for="ville_localisation">
                                             <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-postcard-fill" viewBox="0 0 16 16">
                                                  <path d="M11 8h2V6h-2z"/>
                                                  <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm8.5.5a.5.5 0 0 0-1 0v7a.5.5 0 0 0 1 0zM2 5.5a.5.5 0 0 0 .5.5H6a.5.5 0 0 0 0-1H2.5a.5.5 0 0 0-.5.5M2.5 7a.5.5 0 0 0 0 1H6a.5.5 0 0 0 0-1zM2 9.5a.5.5 0 0 0 .5.5H6a.5.5 0 0 0 0-1H2.5a.5.5 0 0 0-.5.5m8-4v3a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 .5-.5v-3a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5"/>
                                             </svg>
                                             Ville <font color="red">*</font> :
                                        </label>
                                        <input type="text" id="ville_localisation" name="ville_localisation" class="form-control" value="<?php echo e(old('ville_localisation')); ?>" placeholder="Ville" required>
...
unset($__errorArgs, $__bag); ?>
                                   ...
                                   <div class="form-group col-md-12">
                                        <label for="pays_localisation">
                                             <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-postcard-fill" viewBox="0 0 16 16">
                                                  <path d="M11 8h2V6h-2z"/>
                                                  <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm8.5.5a.5.5 0 0 0-1 0v7a.5.5 0 0 0 1 0zM2 5.5a.5.5 0 0 0 .5.5H6a.5.5 0 0 0 0-1H2.5a.5.5 0 0 0-.5.5M2.5 7a.5.5 0 0 0 0 1H6a.5.5 0 0 0 0-1zM2 9.5a.5.5 0 0 0 .5.5H6a.5.5 0 0 0 0-1H2.5a.5.5 0 0 0-.5.5m8-4v3a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 .5-.5v-3a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5"/>
                                             </svg>
                                             Pays <font color="red">*</font> :
                                        </label>
                                        <input type="text" id="pays_localisation" name="pays_localisation" class="form-control" value="<?php echo e(old('quartier_localisation')); ?>" placeholder="Pays" required>
...
<?php /**PATH T:\Soutenance_de_JORDANIE_EVE\Nouveau_Projet\gestion_plateforme_anonces\resources\views/authentification/administrateur/localisation/nouveauLocalisation_administrateur.blade.php ENDPATH**/ ?>