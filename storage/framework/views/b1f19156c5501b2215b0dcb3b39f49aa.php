<!DOCTYPE html>
     ...
     <head>
          ...
          <title>Page d'ouverture administrateur du coté administrateur</title>
     ...
     <body>
          ...
          <div class="container">
            <div class="form-container">
                ...
                <div class="form-left">  
                    <h2>
                        <font color="#000076"><b><strong>Détails adminitrateur</strong></b></font>
                    </h2>
                    ...
                    <form action="<?php echo e(route('updateAdministrateur_administrateur', $user->matricule)); ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="statut">Statut :</label> <strong> <?php echo e($user->statut); ?> </strong>                        
                        </div>
...
<?php /**PATH T:\Soutenance_de_JORDANIE_EVE\Nouveau_Projet\gestion_plateforme_anonces\resources\views/authentification/administrateur/agent/OpenAdministrateur_administrateur.blade.php ENDPATH**/ ?>