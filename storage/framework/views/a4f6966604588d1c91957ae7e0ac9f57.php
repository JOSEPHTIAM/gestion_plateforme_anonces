     ...
     <head>
          ...
          <title>Page de modification du administrateur du coté administrateur</title>
     ...
     <body>
          ...
          <div class="container">
            ...
            <div class="form-container">
                ...
                <div class="form-left">  
                    <h2>
                        <font color="#000076"><b><strong>Modification de l'adminitrateur</strong></b></font>
                    </h2>
                    ...
                    <form action="<?php echo e(route('updateAdministrateur_administrateur', $user->matricule)); ?>" method="POST" enctype="multipart/form-data">
                         <?php echo csrf_field(); ?>
                         <?php echo method_field('POST'); ?>

                         <div class="form-group">
                              <label for="nom">Nom :</label>
                              <input type="text" class="form-control" id="nom" name="nom" value="<?php echo e(old('nom', $user->nom)); ?>" required>
                              <?php $__errorArgs = ['nom'];
...
unset($__errorArgs, $__bag); ?>
                         ...
                         <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="prenom" name="prenom" value="<?php echo e(old('prenom', $user->prenom)); ?>">
...
unset($__errorArgs, $__bag); ?>
                         ...
                         <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="contact" name="contact" value="<?php echo e(old('contact', $user->contact)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                         ...
                         <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="statut" name="statut" value="<?php echo e(old('statut', $user->statut)); ?>">
...
<?php /**PATH T:\Soutenance_de_JORDANIE_EVE\Nouveau_Projet\gestion_plateforme_anonces\resources\views/authentification/administrateur/agent/editAdministrateur_administrateur.blade.php ENDPATH**/ ?>