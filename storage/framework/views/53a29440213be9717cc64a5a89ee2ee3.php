        ...
        <div class="container">
            <div class="navigation">
               ...
               <div class="main">
                    ...
                    <div class="search">
                         <label for="keyword">
                            <input type="text" id="keyword" name="keyword" class="form-control" required placeholder="Rechercher un appareil électromenager">
                    ...
                    <div class="recentOrders">
                        <div class="cardHeader">
                         ...
                         <table class="table table-striped table-hover">
                              ...
                              <tbody>
                                   <?php if(isset($electromenagers)): ?>
                                        <?php $__currentLoopData = $electromenagers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $electromenager): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                             <tr>
                                                    <td>
                                                        <?php if($electromenager->image_electromenager): ?>
                                                            <img src="<?php echo e(asset('storage/images'.'/'.$electromenager->image_electromenager)); ?>" alt="Photo" width="50" height="50">
                                                        <?php else: ?>
                                                                N/A
                                                        <?php endif; ?>
                                                    </td>
                                                    <td><?php echo e($electromenager->id_electromenager); ?></td>
                                                    <td><?php echo e($electromenager->nom_electromenager); ?></td>
                                                    <td><?php echo e($electromenager->puissance_electromenager); ?> Watts</td>
                                                    <td><?php echo e($electromenager->tension_electromenager); ?> Volts</td>
                                                    <td>
                                                        <span class="status pending">
                                                            <a href="<?php echo e(route('editElectromenager_administrateur', $electromenager->id_electromenager)); ?>" class="btn btn-primary" onclick="return confirm('Êtes-vous sûr de vouloir modifier cet appareil électromenager ?');">
                                                                <font color="white"><i class="bi bi-pencil"></i></font>
                                                            </a>
                                                        </span> &nbsp;&nbsp;
                                                        <span class="status return">
                                                            <a href="<?php echo e(url('/deleteElectromenager_administrateur/' . $electromenager->id_electromenager)); ?>" class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet appareil électromenager ?');">
...
</html><?php /**PATH T:\Soutenance_de_JORDANIE_EVE\Nouveau_Projet\gestion_plateforme_anonces\resources\views/authentification/administrateur/electromenager/listeElectromenagers_administrateur.blade.php ENDPATH**/ ?>