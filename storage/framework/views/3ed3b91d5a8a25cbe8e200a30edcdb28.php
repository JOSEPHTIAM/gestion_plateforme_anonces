     ...
     <head>
          ...
          <title>Page de modification de l'ordinateur du coté administrateur</title>
     ...
     <body>
          ...
          <div class="container">
               <div class="form-container">
                    ...
                    <div class="form-left">  
                         <h2 align="center">
                              <font color="#000076"><b><strong>Modification de l'ordinateur</strong></b></font>
                         </h2>
                         ...
                         <form action="<?php echo e(route('updateOrdinateur_administrateur', $ordinateur->id_ordinateur)); ?>" method="POST" enctype="multipart/form-data">
                              <?php echo csrf_field(); ?>
                              ...
                              <div class="form-group">
                                   ...
                                   <?php $__errorArgs = ['image_ordinateur'];
...
unset($__errorArgs, $__bag); ?>
                              ...
                              <div class="form-group">
                                   ...
                                   <input type="text" class="form-control" id="nom_ordinateur" name="nom_ordinateur" value="<?php echo e(old('nom_ordinateur', $ordinateur->nom_ordinateur)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                              ...
                              <div class="form-group">
                                   <label for="processeur">Processeur de l'appareil :</label>
                                   <input type="text" class="form-control" id="processeur" name="processeur" value="<?php echo e(old('processeur', $ordinateur->processeur)); ?>">
...
unset($__errorArgs, $__bag); ?>
                              ...
                              <div class="form-group">
                                   <label for="disque">Disque dur de l'appareil :</label>
                                   <input type="text" class="form-control" id="disque" name="disque" value="<?php echo e(old('disque', $ordinateur->disque)); ?>" required>
                                   <?php $__errorArgs = ['disque'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                              ...
                              <div class="form-group">
                                   <label for="ram">RAM de l'appareil :</label>
                                   <input type="number" class="form-control" id="ram" name="ram" value="<?php echo e(old('ram', $ordinateur->ram)); ?>" required>
                                   <?php $__errorArgs = ['ram'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                              ...
                              <div class="form-group">
                                   <label for="core">Core génération de l'appareil :</label>
                                   <input type="text" class="form-control" id="core" name="core" value="<?php echo e(old('core', $ordinateur->core)); ?>" required>
                                   <?php $__errorArgs = ['disque'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                              ...
                              <div class="form-group text-center">
                                   ...
                                   function listeElectromenagers_administrateur() {
                                        window.location.href = "<?php echo e(url('listeElectromenagers_administrateur')); ?>";
                                   }
                                   </script>
                              </div>
                         </form>
...
<?php /**PATH T:\Soutenance_de_JORDANIE_EVE\Nouveau_Projet\gestion_plateforme_anonces\resources\views/authentification/administrateur/ordinateur/editOrdinateur_administrateur.blade.php ENDPATH**/ ?>