    ...
    <body>
        ...
        <div class="content">
            <div class="center-logo">
                <img id="dynamic-logo" src="<?php echo e(asset('image/logo_principal.jpg')); ?>" alt="Logo plein écran">
            </div>
        </div>
        ...
        <script>
            function listeDesClients() {
                window.location.href = "<?php echo e(url('/listeDesClients')); ?>";
            }
        </script> 
...
<?php /**PATH T:\Soutenance_de_JORDANIE_EVE\Nouveau_Projet\gestion_plateforme_anonces\resources\views/authentification/utilisateur/client/accueilClient.blade.php ENDPATH**/ ?>