          ...
          <div class="container">
               ...
               <div class="form-container">
                    ...
                    <div class="form-left">                    
                         ...
                         <form action="<?php echo e(route('storeService1_administrateur')); ?>" method="post" enctype="multipart/form-data">
                              <?php echo csrf_field(); ?>
                                   ...
                                   <div class="form-group col-md-12">
                                        ...
                                        <select name="id_localisation" id="id_localisation" class="form-control" required>
                                             ...
                                             <?php $__currentLoopData = \App\Models\Localisation::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $localisation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                  <option value="<?php echo e($localisation->id_localisation); ?>">
                              ...
                              <div class="form-row">
                                   <div class="form-group col-md-12">
                                        ...
                                        <select name="matricule" id="matricule" class="form-control" required>
                                             ...
                                             <?php $__currentLoopData = \App\Models\User::where('role', 'Administrateur')->orWhere('role', 'Agent')->paginate(1000); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                  <option value="<?php echo e($user->matricule); ?>">
                              ...
                              <div class="form-row">
                                   <div class="form-group col-md-12">
                                        ...
                                        <select name="id_ordinateur" id="id_ordinateur" class="form-control">
                                             <option value="">Sélectionner un appareil ordinateur</option>
                                             <?php $__currentLoopData = \App\Models\Ordinateur::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ordinateur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                  <option value="<?php echo e($ordinateur->id_ordinateur); ?>">
                              ...
                              <div class="form-row">
                                   <div class="form-group col-md-12">
                                        ...
                                        <input type="text" id="description_service" name="description_service" class="form-control" value="<?php echo e(old('description_service')); ?>" placeholder="Meilleure performance">
                                   </div>
                              </div>
                              ...
                              <div class="form-row">
                                   ...
                                   <input type="number" id="prix_service" name="prix_service" class="form-control" value="<?php echo e(old('prix_service')); ?>" placeholder="Ex: 400" required min="0" oninput="calculateTotal()">
                                   </div>
                              </div>
                                   ...
                                   <div class="form-group col-md-12">
                                        ...
                                        <select name="id_magasin" id="id_magasin" class="form-control" required onchange="calculateTotal()">
                                             ...
                                             <?php $__currentLoopData = \App\Models\Magasin::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $magasin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                  <option value="<?php echo e($magasin->id_magasin); ?>" data-stock="<?php echo e($magasin->stock_magasin); ?>">
                              ...
                              <div class="form-row">
                                   <div class="form-group col-md-12">
                                        ...
                                        <input type="number" id="total_service" name="total_service" class="form-control" value="<?php echo e(old('total_service')); ?>" placeholder="Génération automatique du prix total" required min="0" readonly>
                                   </div>
                              </div>
                              ...
                              <div class="form-group text-center">
                                   ...
                                   function listeServices_administrateur() {
                                        window.location.href = "<?php echo e(url('listeServices_administrateur')); ?>";
                                   }
                                   </script>
                              </div>
                         </form>
...
<?php /**PATH T:\Soutenance_de_JORDANIE_EVE\Nouveau_Projet\gestion_plateforme_anonces\resources\views/authentification/administrateur/service/nouveauService1_administrateur.blade.php ENDPATH**/ ?>