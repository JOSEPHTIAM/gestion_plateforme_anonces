...
<html lang="en">
    ...
    <head>
        ...
        <title>Liste des localisations chez l'administrateur</title>
        ...
        <div class="container">
            <div class="navigation">
                <ul>
                    ...
                    <li>
                        <a href="<?php echo e(route('listeLocalisations_administrateur')); ?>">
                            ...
                            <span class="title_actuellement">Localisations</span>
                        </a>
                    </li>
               ...
               <div class="main">
                    ...
                    <form action="/searchLocalisation_administrateur" class="form-inline">
                    <div class="topbar">
                    <div class="toggle">
                    ...
                    <div class="search">
                         <label for="keyword">
                            <input type="text" id="keyword" name="keyword" class="form-control" required placeholder="Rechercher une localisation">
                ...
                <div class="details">
                    <div class="recentOrders">
                        <div class="cardHeader">
                            <h2 align="center"><font size="7">LISTE DES LOCALISATIONS</font></h2>
                            <a href="/nouveauLocalisation_administrateur" class="btn_nouveau">
                         ...
                         <table class="table table-striped table-hover">
                              ...
                              <tbody>
                                   <?php if(isset($localisations)): ?>
                                        <?php $__currentLoopData = $localisations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $localisation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                             <tr>
                                                    <td><?php echo e($localisation->id_localisation); ?></td>
                                                    <td><?php echo e($localisation->nom_localisation); ?></td>
                                                    <td><?php echo e($localisation->quartier_localisation); ?></td>
                                                    <td><?php echo e($localisation->ville_localisation); ?></td>
                                                    <td><?php echo e($localisation->pays_localisation); ?></td>
                                                    <td>
                                                        <span class="status pending">
                                                            <a href="<?php echo e(route('editLocalisation_administrateur', $localisation->id_localisation)); ?>" class="btn btn-primary" onclick="return confirm('Êtes-vous sûr de vouloir modifier cette localisation ?');">
                                                                <font color="white"><i class="bi bi-pencil"></i></font>
                                                            </a>
                                                        </span> &nbsp;&nbsp;
                                                        <span class="status return">
                                                            <a href="<?php echo e(url('/deleteLocalisation_administrateur/' . $localisation->id_localisation)); ?>" class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cette localisation ?');">
...
</html><?php /**PATH T:\Soutenance_de_JORDANIE_EVE\Nouveau_Projet\gestion_plateforme_anonces\resources\views/authentification/administrateur/localisation/listeLocalisations_administrateur.blade.php ENDPATH**/ ?>