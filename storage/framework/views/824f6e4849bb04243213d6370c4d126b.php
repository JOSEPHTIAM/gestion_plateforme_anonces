<!DOCTYPE html>
     ...
     <head>
          ...
          <title>Page du nouvel appareil electronique du coté administrateur</title>
     ...
     <body>
          ...
          <div class="container">
               ...
               <div class="form-container">
                    ...
                    <div class="form-left">                    
                         <h2 align="center">
                              <font color="#000076"><b><strong>Nouvel appareil électronique</strong></b></font>
                         </h2>
                         ...
                         <form action="<?php echo e(route('storeElectromenager_administrateur')); ?>" method="post" enctype="multipart/form-data">
                              <?php echo csrf_field(); ?>
                                                            
                              <div class="form-row">
                                    <div class="form-group col-md-12">
                                        <label for="image_electromenager">
                                            <i class="fas fa-graduation-cap"></i> 
                                            Photo :
                                        </label>
                                        <input type="file" id="image_electromenager" name="image_electromenager" class="form-control" value="<?php echo e(old('image_electromenager')); ?>">
                                   </div>
                                   
                                   <div class="form-group col-md-12">
                                        <label for="nom_electromenager">
                                        ...
                                        <input type="text" id="nom_electromenager" name="nom_electromenager" class="form-control" value="<?php echo e(old('nom_electromenager')); ?>" placeholder="Modem Wifi" required>
                                        <?php $__errorArgs = ['nom_electromenager'];
...
unset($__errorArgs, $__bag); ?>
                              ...
                              <div class="form-row">
                                   <div class="form-group col-md-12">
                                        <label for="puissance_electromenager">
                                             <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-postcard-fill" viewBox="0 0 16 16">
                                                  <path d="M11 8h2V6h-2z"/>
                                                  <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm8.5.5a.5.5 0 0 0-1 0v7a.5.5 0 0 0 1 0zM2 5.5a.5.5 0 0 0 .5.5H6a.5.5 0 0 0 0-1H2.5a.5.5 0 0 0-.5.5M2.5 7a.5.5 0 0 0 0 1H6a.5.5 0 0 0 0-1zM2 9.5a.5.5 0 0 0 .5.5H6a.5.5 0 0 0 0-1H2.5a.5.5 0 0 0-.5.5m8-4v3a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 .5-.5v-3a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5"/>
                                             </svg>
                                             Puissance de l'appareil <font color="red">*</font> :
                                        </label>
                                        <input type="number" id="puissance_electromenager" name="puissance_electromenager" class="form-control" value="<?php echo e(old('puissance_electromenager')); ?>" placeholder="42" required>
                                        <?php $__errorArgs = ['puissance_electromenager'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                                   ...
                                   <div class="form-group col-md-12">
                                        <label for="tension_electromenager">
                                             <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-postcard-fill" viewBox="0 0 16 16">
                                                  <path d="M11 8h2V6h-2z"/>
                                                  <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm8.5.5a.5.5 0 0 0-1 0v7a.5.5 0 0 0 1 0zM2 5.5a.5.5 0 0 0 .5.5H6a.5.5 0 0 0 0-1H2.5a.5.5 0 0 0-.5.5M2.5 7a.5.5 0 0 0 0 1H6a.5.5 0 0 0 0-1zM2 9.5a.5.5 0 0 0 .5.5H6a.5.5 0 0 0 0-1H2.5a.5.5 0 0 0-.5.5m8-4v3a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 .5-.5v-3a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5"/>
                                             </svg>
                                             Tension de l'appareil <font color="red">*</font> :
                                        </label>
                                        <input type="number" id="tension_electromenager" name="tension_electromenager" class="form-control" value="<?php echo e(old('tension_electromenager')); ?>" placeholder="12" required>
...
<?php /**PATH T:\Soutenance_de_JORDANIE_EVE\Nouveau_Projet\gestion_plateforme_anonces\resources\views/authentification/administrateur/electromenager/nouveauElectromenager_administrateur.blade.php ENDPATH**/ ?>