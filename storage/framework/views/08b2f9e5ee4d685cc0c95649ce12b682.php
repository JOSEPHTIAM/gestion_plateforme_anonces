          ...
          <div class="container">
               ...
               <div class="form-container">
                    ...
                    <div class="form-left">  
                         ...
                         <form action="<?php echo e(route('updateElectromenager_administrateur', $electromenager->id_electromenager)); ?>" method="POST" enctype="multipart/form-data">
                              <?php echo csrf_field(); ?>
                              <?php echo method_field('POST'); ?>

                              <div class="form-group">
                                   <label for="nom_electromenager">Nom de l'appareil :</label>
                                   <input type="text" class="form-control" id="nom_electromenager" name="nom_electromenager" value="<?php echo e(old('nom_electromenager', $electromenager->nom_electromenager)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                              ...
                              <div class="form-group">
                                   ...
                                   <input type="number" class="form-control" id="puissance_electromenager" name="puissance_electromenager" value="<?php echo e(old('puissance_electromenager', $electromenager->puissance_electromenager)); ?>">
...
unset($__errorArgs, $__bag); ?>
                              ...
                              <div class="form-group">
                                   ...
                                   <input type="number" class="form-control" id="tension_electromenager" name="tension_electromenager" value="<?php echo e(old('tension_electromenager', $electromenager->tension_electromenager)); ?>" required>
...
<?php /**PATH T:\Soutenance_de_JORDANIE_EVE\Nouveau_Projet\gestion_plateforme_anonces\resources\views/authentification/administrateur/electromenager/editElectromenager_administrateur.blade.php ENDPATH**/ ?>