...
<html lang="en">
    ...
    <head>
        ...
        <title>Liste des ordinateurs chez l'administrateur</title>
        ...
        <div class="container">
            <div class="navigation">
                <ul>
                    ...
                    <li>
                        <a href="<?php echo e(route('listeOrdinateurs_administrateur')); ?>">
                            ...
                            <span class="title_actuellement">Ordinateurs</span>
                        </a>
                    </li>
               ...
               <div class="main">
                    ...
                    <form action="/searchOrdinateur_administrateur" class="form-inline">
                    <div class="topbar">
                    <div class="toggle">
                    ...
                    <div class="search">
                         <label for="keyword">
                            <input type="text" id="keyword" name="keyword" class="form-control" required placeholder="Rechercher un appareil ordinateur">
                ...
                <div class="details">
                    <div class="recentOrders">
                        <div class="cardHeader">
                            <h2 align="center"><font size="7">LISTE DES APPAREILS ORDINATEURS</font></h2>
                            <a href="/nouveauOrdinateur_administrateur" class="btn_nouveau">
                            ...
                            <table class="table table-striped table-hover">
                              ...
                              <tbody>
                                   <?php if(isset($ordinateurs)): ?>
                                        <?php $__currentLoopData = $ordinateurs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ordinateur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                             <tr>
                                                    <td>
                                                        <?php if($ordinateur->image_ordinateur): ?>
                                                            <img src="<?php echo e(asset('storage/images'.'/'.$ordinateur->image_ordinateur)); ?>" alt="Photo" width="50" height="50">
                                                        <?php else: ?>
                                                                N/A
                                                        <?php endif; ?>
                                                    </td>
                                                    <td><?php echo e($ordinateur->id_ordinateur); ?></td>
                                                    <td><?php echo e($ordinateur->nom_ordinateur); ?></td>
                                                    <td><?php echo e($ordinateur->processeur); ?></td>
                                                    <td><?php echo e($ordinateur->disque); ?> GO</td>
                                                    <td><?php echo e($ordinateur->ram); ?> GO</td>
                                                    <td><?php echo e($ordinateur->core); ?></td>
                                                    <td>
                                                        <span class="status pending">
                                                            <a href="<?php echo e(route('editOrdinateur_administrateur', $ordinateur->id_ordinateur)); ?>" class="btn btn-primary" onclick="return confirm('Êtes-vous sûr de vouloir modifier cet appareil ordinateur ?');">
                                                                <font color="white"><i class="bi bi-pencil"></i></font>
                                                            </a>
                                                        </span> &nbsp;&nbsp;
                                                        <span class="status return">
                                                            <a href="<?php echo e(url('/deleteOrdinateur_administrateur/' . $ordinateur->id_ordinateur)); ?>" class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet appareil ordinateur ?');">
...
</html><?php /**PATH T:\Soutenance_de_JORDANIE_EVE\Nouveau_Projet\gestion_plateforme_anonces\resources\views/authentification/administrateur/ordinateur/listeOrdinateurs_administrateur.blade.php ENDPATH**/ ?>