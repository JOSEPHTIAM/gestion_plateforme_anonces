          ...
          <div class="container">
               ...
               <div class="form-container">
                    ...
                    <div class="form-left">                    
                         ...
                         <form action="<?php echo e(route('store_client')); ?>" method="post" enctype="multipart/form-data">
                              <?php echo csrf_field(); ?>
                              ...
                              <div class="form-row">
                                   <div class="form-group col-md-12">
                                        ...
                                        <input type="tel" id="contact" name="contact" class="form-control" value="<?php echo e(old('contact')); ?>" required>
                                   </div>                    
                              </div>
                              ...
                              <div class="form-row d-none" id="agentFields">
                                   ...
                                   <div class="form-group col-md-12">
                                        ...
                                        <input type="text" id="numero_societe" name="numero_societe" class="form-control" value="<?php echo e(old('numero_societe')); ?>">
                                   </div>
                                   <div class="form-group col-md-12">
                              ...
                              <div class="form-group text-center">
                                   ...
                                   function listeClients_administrateur() {
                                        window.location.href = "<?php echo e(url('listeClients_administrateur')); ?>";
                                   }
                                   </script>
                              </div>
                         </form>
...
<?php /**PATH T:\Soutenance_de_JORDANIE_EVE\Nouveau_Projet\gestion_plateforme_anonces\resources\views/authentification/administrateur/agent/nouveauClient_administrateur.blade.php ENDPATH**/ ?>