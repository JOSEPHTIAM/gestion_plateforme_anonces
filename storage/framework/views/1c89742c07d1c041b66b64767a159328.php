                    ...
                    <div class="recentOrders">
                                   ...
                                   <?php if(isset($services)): ?>
                                        <?php $__currentLoopData = $services; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                             <tr>
                                                    ...
                                                    <td>
                                                        <?php if($service->electromenager->image_electromenager): ?>
                                                            <img src="<?php echo e(asset('storage/images'.'/'.$service->electromenager->image_electromenager)); ?>" alt="Photo" width="50" height="50">
                                                        <?php else: ?>
                                                            N/A
                                                        <?php endif; ?>
                                                    </td>                                                  
                                                    <td><?php echo e($service->electromenager->nom_electromenager); ?></td>
                                                    <td><?php echo e($service->prix_service); ?> CFA</td>
                                                    <td><?php echo e($service->magasin->stock_magasin); ?></td>
                                                    <td><?php echo e($service->total_service); ?> CFA</td>
                                                    <td><?php echo e($service->description_service); ?></td>
                                                    <td>"<?php echo e($service->user->role); ?>" : &nbsp;&nbsp;<?php echo e($service->user->nom); ?> <?php echo e($service->user->prenom); ?></td>
                                                    <td>                                                        
                                                        <span class="status actuellement_pink">
                                                            <a href="#" class="btn btn-success add-to-cart" 
                                                                data-service-id="<?php echo e($service->id_service); ?>" 
                                                                data-service-name="<?php echo e($service->electromenager->nom_electromenager); ?>"
                                                                data-service-unitaire="<?php echo e($service->prix_service); ?>"
                                                                data-service-stock="<?php echo e($service->magasin->stock_magasin); ?>"
                                                                data-service-price="<?php echo e($service->total_service); ?>"    
                                                                data-service-vendeurNom="<?php echo e($service->user->nom); ?>"
                                                                data-service-vendeurPrenom="<?php echo e($service->user->prenom); ?>"
                                                                data-service-role="<?php echo e($service->user->role); ?>"
                                                                data-service-localisation="<?php echo e($service->localisation->nom_localisation); ?>"                                                          
                                                            >                                                                  
                                                                <font color="white"><ion-icon name="cart-outline"></ion-icon></font>
                                                            </a>       
                                                        </span> &nbsp;&nbsp;                                                        
                                                        <span class="status actuellement">
                                                            <a href="<?php echo e(url('/OpenService_administrateur/' . $service->id_service)); ?>" class="btn btn-secondary" onclick="return confirm('Êtes-vous sûr de visualiser les détails de ce service électromenager ?');">
                                                                <font color="white"><ion-icon name="eye-outline"></ion-icon></font>
                                                            </a>
                                                        </span> &nbsp;&nbsp;
                                                        <span class="status pending">
                                                            <a href="<?php echo e(route('editService_administrateur', $service->id_service)); ?>" class="btn btn-primary" onclick="return confirm('Êtes-vous sûr de vouloir modifier ce service électromenager ?');">
                                                                <font color="white"><i class="bi bi-pencil"></i></font>
                                                            </a>
                                                        </span> &nbsp;&nbsp;
                                                        <span class="status return">
                                                            <a href="<?php echo e(url('/deleteService_administrateur/' . $service->id_service)); ?>" class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce service électromenager ?');">
                                        ...
                                        <?php $__currentLoopData = \App\Models\Service::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                             <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <span class="status actuellement">
                                                            <a href="<?php echo e(url('/OpenService_administrateur/' . $service->id_service)); ?>" class="btn btn-secondary" onclick="return confirm('Êtes-vous sûr de visualiser les détails de ce service ?');">
                                                                <font color="white"><ion-icon name="eye-outline"></ion-icon></font>
                                                            </a>
                                                        </span> &nbsp;&nbsp;
                                                        <span class="status pending">
                                                            <a href="<?php echo e(route('editService_administrateur', $service->id_service)); ?>" class="btn btn-primary" onclick="return confirm('Êtes-vous sûr de vouloir modifier ce service ?');">
                                                                <font color="white"><i class="bi bi-pencil"></i></font>
                                                            </a>
                                                        </span> &nbsp;&nbsp;
                                                        <span class="status return">
                                                            <a href="<?php echo e(url('/deleteService_administrateur/' . $service->id_service)); ?>" class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce service ?');">
                                                                <font color="white"><i class="bi bi-trash"></i></font>
                                                            </a>
                                                        </span>                                                         
                                                    </td> 
                        ...
                        <hr color="#2a2185" size="6">
                         <table class="table table-striped table-hover">
                              ...
                              <tbody>
                                   <?php if(isset($services1)): ?>
                                        <?php $__currentLoopData = $services1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                             <tr>
                                                    <td><?php echo e($service1->id_service1); ?></td>   
                                                    <td>
                                                        <?php if($service1->ordinateur->image_ordinateur): ?>
                                                            <img src="<?php echo e(asset('storage/images'.'/'.$service1->ordinateur->image_ordinateur)); ?>" alt="Photo" width="50" height="50">
                                                        <?php else: ?>
                                                            N/A
                                                        <?php endif; ?>
                                                    </td>
                                                                                                     
                                                    <td><?php echo e($service1->ordinateur->nom_ordinateur); ?></td>
                                                    <td><?php echo e($service1->prix_service); ?> CFA</td>
                                                    <td><?php echo e($service1->magasin->stock_magasin); ?></td>
                                                    <td><?php echo e($service1->total_service); ?> CFA</td>
                                                    <td><?php echo e($service1->description_service); ?></td>
                                                    <td>"<?php echo e($service1->user->role); ?>" : &nbsp;&nbsp;<?php echo e($service1->user->nom); ?> <?php echo e($service1->user->prenom); ?></td>
                                                    <td>
                                                        <span class="status actuellement_pink">
                                                            <a href="#" class="btn btn-success add-to-cart" 
                                                                data-service-id="<?php echo e($service1->id_service1); ?>" 
                                                                data-service-name="<?php echo e($service1->ordinateur->nom_ordinateur); ?>"
                                                                data-service-unitaire="<?php echo e($service1->prix_service); ?>"
                                                                data-service-stock="<?php echo e($service1->magasin->stock_magasin); ?>"
                                                                data-service-price="<?php echo e($service1->total_service); ?>"   
                                                                data-service-vendeurNom="<?php echo e($service1->user->nom); ?>"
                                                                data-service-vendeurPrenom="<?php echo e($service1->user->prenom); ?>"
                                                                data-service-role="<?php echo e($service1->user->role); ?>"
                                                                data-service-localisation="<?php echo e($service1->localisation->nom_localisation); ?>"
                                                            > 
                                                            <font color="white"><ion-icon name="cart-outline"></ion-icon></font>
                                                            </a>
                                                        </span> &nbsp;&nbsp;
                                                        <span class="status actuellement">
                                                            <a href="<?php echo e(url('/OpenService1_administrateur/' . $service1->id_service1)); ?>" class="btn btn-secondary" onclick="return confirm('Êtes-vous sûr de visualiser les détails de ce service ordinateur ?');">
                                                                <font color="white"><ion-icon name="eye-outline"></ion-icon></font>
                                                            </a>
                                                        </span> &nbsp;&nbsp;
                                                        <span class="status pending">
                                                            <a href="<?php echo e(route('editService1_administrateur', $service1->id_service1)); ?>" class="btn btn-primary" onclick="return confirm('Êtes-vous sûr de vouloir modifier ce service ordinateur ?');">
                                                                <font color="white"><i class="bi bi-pencil"></i></font>
                                                            </a>
                                                        </span> &nbsp;&nbsp;
                                                        <span class="status return">
                                                            <a href="<?php echo e(url('/deleteService1_administrateur/' . $service1->id_service1)); ?>" class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce service ordinateur ?');">
                                                                <font color="white"><i class="bi bi-trash"></i></font>
                                                            </a>
                                                        </span>                                                         
                                                    </td> 
                                        ...
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                   <?php else: ?>
                                        <?php $__currentLoopData = \App\Models\Service1::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $service1): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td><?php echo e($service1->id_service1); ?></td>
                                                    <td>
                                                        <?php if($service1->ordinateur->image_ordinateur): ?>
...
</html><?php /**PATH T:\Soutenance_de_JORDANIE_EVE\Nouveau_Projet\gestion_plateforme_anonces\resources\views/authentification/administrateur/service/listeServices_administrateur.blade.php ENDPATH**/ ?>