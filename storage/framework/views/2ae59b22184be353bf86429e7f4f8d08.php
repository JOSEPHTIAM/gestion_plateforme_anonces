...
<html lang="en">
    ...
    <head>
        ...
        <title>Liste des magasins chez l'administrateur</title>
        ...
        <div class="container">
            <div class="navigation">
                <ul>
                    ...
                    <li>
                        <a href="<?php echo e(route('listeMagasins_administrateur')); ?>">
                            ...
                            <span class="title_actuellement">Magasin</span>
                        </a>
                    </li>
               ...
               <div class="main">
                    ...
                    <form action="/searchMagasin_administrateur" class="form-inline">
                    <div class="topbar">
                    <div class="toggle">
                    ...
                    <div class="search">
                         <label for="keyword">
                            <input type="text" id="keyword" name="keyword" class="form-control" required placeholder="Rechercher un magasin">
                ...
                <div class="details">
                    <div class="recentOrders">
                        <div class="cardHeader">
                            <h2 align="center"><font size="7">LISTE DES MAGASINS</font></h2>
                            <a href="/nouveauMagasin_administrateur" class="btn_nouveau">
                              ...
                              <tbody>
                                   <?php if(isset($magasins)): ?>
                                        <?php $__currentLoopData = $magasins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $magasin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                             <tr>
                                                    <td><?php echo e($magasin->id_magasin); ?></td>
                                                    <td><?php echo e($magasin->stock_magasin); ?></td>
                                                    <td>
                                                        <span class="status pending">
                                                            <a href="<?php echo e(route('editMagasin_administrateur', $magasin->id_magasin)); ?>" class="btn btn-primary" onclick="return confirm('Êtes-vous sûr de vouloir modifier ce magasin ?');">
                                                                <font color="white"><i class="bi bi-pencil"></i></font>
                                                            </a>
                                                        </span> &nbsp;&nbsp;
                                                        <span class="status return">
                                                            <a href="<?php echo e(url('/deleteMagasin_administrateur/' . $magasin->id_magasin)); ?>" class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce magasin ?');">
...
</html><?php /**PATH T:\Soutenance_de_JORDANIE_EVE\Nouveau_Projet\gestion_plateforme_anonces\resources\views/authentification/administrateur/magasin/listeMagasins_administrateur.blade.php ENDPATH**/ ?>