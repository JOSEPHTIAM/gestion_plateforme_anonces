...
<html lang="en">
    ...
    <head>
        ...
        <title>Liste des clients chez l'administrateur</title>
        ...
        <div class="container">
            <div class="navigation">
                <ul>
                    ...
                    <li>
                        <a href="<?php echo e(route('listeClients_administrateur')); ?>">
                            <span class="icon_actuellement">
                                <ion-icon name="people-outline"></ion-icon>
                            </span>
                            <span class="title_actuellement">Clients</span>
                        </a>
                    </li>

                    <li>
                        <a href="<?php echo e(route('listeAgents_administrateur')); ?>">
                            <span class="icon">
                                <ion-icon name="people-outline"></ion-icon>
                            </span>
                    ...
                    <li>
                        <a href="<?php echo e(route('listeAdministrateurs_administrateur')); ?>">
                            <span class="icon">
                                <ion-icon name="people-outline"></ion-icon>
                            </span>
               ...
               <div class="main">
                    ...
                    <form action="/searchClient_agent" class="form-inline">
                    <div class="topbar">
                    <div class="toggle">
                    ...
                    <div class="search">
                         <label for="keyword">
                            <input type="text" id="keyword" name="keyword" class="form-control" required placeholder="Rechercher un client">
                ...
                <div class="details">
                    <div class="recentOrders">
                        <div class="cardHeader">
                            <h2 align="center"><font size="7">LISTE DES CLIENTS</font></h2>
                            
                            <a href="/nouveauClient_administrateur" class="btn_nouveau">
                         ...
                         <table class="table table-striped table-hover">
                              ...
                              <tbody>
                                   <?php if(isset($users)): ?>
                                        <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                             <tr>
                                                  <td>
                                                       <?php if($user->photo): ?>
                                                            <img src="<?php echo e(asset('storage/images'.'/'.$user->photo)); ?>" alt="Photo" width="50" height="50">
                                                       <?php else: ?>
                                                            N/A
                                                       <?php endif; ?>
                                                  </td>
                                                    ...
                                                    <td>
                                                        <span class="status actuellement">
                                                            <a href="<?php echo e(url('/OpenClient_administrateur/' . $user->matricule)); ?>" class="btn btn-secondary" onclick="return confirm('Êtes-vous sûr de visualiser les détails de ce client ?');">
                                                                <font color="white"><ion-icon name="eye-outline"></ion-icon></font>
                                                            </a>
                                                        </span> &nbsp;&nbsp;
                                                        <span class="status pending">
                                                            <a href="<?php echo e(route('editClient_administrateur', $user->matricule)); ?>" class="btn btn-primary" onclick="return confirm('Êtes-vous sûr de vouloir modifier ce client ?');">
                                                                <font color="white"><i class="bi bi-pencil"></i></font>
                                                            </a>
                                                        </span> &nbsp;&nbsp;
                                                        <span class="status return">
                                                            <a href="<?php echo e(url('/deleteClient_administrateur/' . $user->matricule)); ?>" class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir modifier ce client ?');">
                                   ...
                                   <?php else: ?>
                                        <?php $__currentLoopData = \App\Models\User::where('role', 'Client')->paginate(1000); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                             <tr>
                                                  <td>
                                                       <?php if($user->photo): ?>
                                                            <img src="<?php echo e(asset('storage/images'.'/'.$user->photo)); ?>" alt="Photo" width="50" height="50">
                                                    ...
                                                    <td>
                                                        ...
                                                        <span class="status return">
                                                            <a href="<?php echo e(url('/deleteClient_administrateur/' . $user->matricule)); ?>" class="btn btn-danger" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce client ?');">
                                                                <font color="white"><i class="bi bi-trash"></i></font>
                                                            </a>
                                                        </span>                                                         
                                                    </td>                                                    
...
</html><?php /**PATH T:\Soutenance_de_JORDANIE_EVE\Nouveau_Projet\gestion_plateforme_anonces\resources\views/authentification/administrateur/agent/listeClients_administrateur.blade.php ENDPATH**/ ?>